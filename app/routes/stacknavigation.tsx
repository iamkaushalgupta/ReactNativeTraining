...
import { HomeModel, ContactModel, ProfileModel, TestModel, PhoneOTPModel } from '../viewModels'
import { createNativeStackNavigator } from '@react-navigation/native-stack'
import { NavigationContainer } from '@react-navigation/native';
import MobileOTP from "../views/OTP";
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator initialRouteName="PhoneOTP">
                ...
                {/* <Stack.Screen name = "PhoneOTP" component ={PhoneOTPModel}></Stack.Screen> */}
                <Stack.Screen name="PhoneOTP" component={MobileOTP}></Stack.Screen>
            </Stack.Navigator>
        </NavigationContainer>
