...
import {HomeModel, ContactModel, ProfileModel,TestModel,TipsiStripeModel} from '../viewModels'
...
const MainStack =()=>
{
    return(
        <NavigationContainer>
        <Stack.Navigator initialRouteName="TipsiStripe">
            ...
            <Stack.Screen name = "TipsiStripe" component ={TipsiStripeModel}></Stack.Screen>
        </Stack.Navigator>
        </NavigationContainer>
