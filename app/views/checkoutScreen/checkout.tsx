...
const CheckoutScreen = ({ navigation }: any) => {
    ...
    return (
        <View style={styles.container}>
            <HeaderComponent firstImage={icons.left_arrow} secondImage={images.transparent} navigation={navigation} heading={string.screens.Checkout} secondImageNavigate={""} firstImageNavigate={navigation.goBack} />
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <View>
                    ...
                    <View style={styles.couponContainer}>
                        <TextInput placeholderTextColor={COLORS.gray} placeholder={string.keywords.couponCode} style={styles.textInput}></TextInput>
