...
const MyCardScreen = ({ navigation }: any) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.addButton} onPress={() => {(string.MyCards[select-1].oldCard=="yes")?navigation.navigate("Checkout"):navigation.navigate('AddNewCard')}}>
                <Text style={styles.addText}>{(string.MyCards[select-1].oldCard=="yes")?string.keywords.checkout:string.keywords.add}</Text>
            </TouchableOpacity>
